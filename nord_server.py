...
def resolve_default_upload_dir():
    db_dir = os.path.dirname(os.path.abspath(DB_PATH or "")) or BASE_DIR
    return os.path.join(db_dir, "uploads")


UPLOAD_DIR = os.environ.get("NORD_UPLOAD_DIR", "").strip() or resolve_default_upload_dir()
